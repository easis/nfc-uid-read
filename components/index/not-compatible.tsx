    ...
    return (
        <>
            ...
            <Button onClick={props.onRetry} className='inline-flex items-center' disabled={!props.canRetry}>
                <svg xmlns="http://www.w3.org/2000/svg" className="mr-2" width="18" height="18" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor" fill="none" strokeLinecap="round" strokeLinejoin="round">
